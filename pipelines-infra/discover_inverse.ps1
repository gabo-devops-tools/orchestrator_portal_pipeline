...
$longstring = "status"
$containstf = Get-ChildItem -Path $workingDirectory  -Recurse -Include "*.tf" | ForEach-Object { $_.Directory.FullName } | Where-Object { $_ -notmatch "disable" }  | Sort-Object -Unique -Descending
